function pre_grid = SE0P_gridding_precomp(x, opt)
%SE0P_gridding_precomp  Precomputation of fast gridding data
%
%   pre_grid = SE0P_gridding_precomp(x, opt)
%
%   Input parameters:

...
#define EWALD_KERNEL SE3P_Stokeslet_direct_real
#define EWALD_TAG "3P_REAL"
#elif TWO_PERIODIC
#define EWALD_KERNEL SE2P_Stokeslet_direct_real
#define EWALD_TAG "2P_REAL"
#elif ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokeslet_direct_real
#define EWALD_TAG "1P_REAL"
#elif ZERO_PERIODIC
#define EWALD_KERNEL SE0P_Stokeslet_direct_real
...
#ifdef EWALD_FULL
#ifdef ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokeslet_direct_full
#define EWALD_TAG "1P_FULL"
#elif ZERO_PERIODIC
#define EWALD_KERNEL SE0P_Stokeslet_direct_full
...
#ifdef EWALD_FOURIER
#ifdef THREE_PERIODIC
#define EWALD_KERNEL SE3P_Stokeslet_direct_fourier
#define EWALD_TAG "3P_FOURIER"
#elif TWO_PERIODIC
#define EWALD_KERNEL SE2P_Stokeslet_direct_fourier
#define EWALD_TAG "2P_FOURIER"
#elif ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokeslet_direct_fourier
...
#ifdef TWO_PERIODIC
#define EWALD_KERNEL SE2P_Stokeslet_direct_fourier_k0
#define EWALD_TAG "2P_FOURIER_K0"
#elif ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokeslet_direct_fourier_k0
...
#ifdef EWALD_SELF
#ifdef THREE_PERIODIC
#define EWALD_KERNEL SE3P_Stokeslet_direct_self
#define EWALD_TAG "3P_SELF"
#elif TWO_PERIODIC
#define EWALD_KERNEL SE2P_Stokeslet_direct_self
#define EWALD_TAG "2P_SELF"
#elif ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokeslet_direct_self
                 ...
                 int nrhs, const mxArray *prhs[] )
{
    ...
    // Input dimensions, X and F should be N-by-3
    if (mxGetNumberOfElements(X) > 0 && mxGetN(X) != 3)
        mexErrMsgIdAndTxt("SE:DirectMEXOpt", "x must be N-by-3");
    const size_t N = mxGetM(X);
    if (mxGetM(F) != N || mxGetN(F) != mxGetN(X))
        mexErrMsgIdAndTxt("SE:DirectMEXOpt", "f must be N-by-3");
    ...
    {
#ifdef EXTERNAL
        __PRINTF("\n[DIRECT STOKESLET EWALD (%s EXT)] MEX N=(%d,%d) ", EWALD_TAG, N, num_eval);
#elif CUTOFF
        __PRINTF("\n[DIRECT STOKESLET EWALD (%s CUT)] MEX N=(%d,%d) ", EWALD_TAG, N, num_eval);
#else
        __PRINTF("\n[DIRECT STOKESLET EWALD (%s)] MEX N=(%d,%d) ", EWALD_TAG, N, num_eval);
#endif
